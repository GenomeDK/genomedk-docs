...
# -*- coding: utf-8 -*-
#
# GenomeDK documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.todo', 'events', 'kill_html_js']
...
html_theme_options = {
    ...
    'email': 'cases@genomedk.manuscript.com',
    'show_breadcrumb': 'no',
}
...
man_pages = [
    (master_doc, 'genomedkdocs', 'GenomeDK Documentation',
     [author], 1)
]
