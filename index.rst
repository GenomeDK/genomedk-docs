...
.. container:: lead
  ...
  GenomeDK is a national high-performance computing facility with a particular
  focus on security and data intensive applications.

GenomeDK is used for many fields of research and has a strong track record in
bioinformatics and the life sciences.

We provide **strong security by default**. GenomeDK is ISO 27001-certified and
receives yearly ISAE-3000 declarations with a focus on GDPR. Our *closed zones*
build on top of this by adding data export mechanisms, isolating computations,
and limiting access to the Internet. You can :ref:`read more here
<about_zones>`.

The system is comprised of 84 nodes (4380 cores) connected with Infiniband. Each
